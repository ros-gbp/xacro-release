## xacro (noetic) - 1.14.20-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Thu, 20 Mar 2025 07:07:07 -0000`
...
## xacro (noetic) - 1.14.19-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Fri, 20 Dec 2024 09:05:40 -0000`
...
## xacro (noetic) - 1.14.18-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Tue, 02 Apr 2024 07:23:48 -0000`
...
- upstream repository: https://github.com/ros/xacro.git
- release repository: https://github.com/ros-gbp/xacro-release.git
- rosdistro version: `1.14.17-2`
- old version: `1.14.17-2`
...
## xacro (noetic) - 1.14.17-2

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Thu, 25 Jan 2024 02:26:04 -0000`
...
## xacro (noetic) - 1.14.17-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Thu, 25 Jan 2024 02:03:54 -0000`
...
## xacro (noetic) - 1.14.15-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Mon, 27 Feb 2023 20:48:50 -0000`
...
## xacro (melodic) - 1.13.19-1

The packages in the `xacro` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic xacro` on `Mon, 27 Feb 2023 20:37:59 -0000`
...
## xacro (noetic) - 1.14.14-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Sat, 22 Oct 2022 21:28:06 -0000`
...
## xacro (melodic) - 1.13.18-1

The packages in the `xacro` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic xacro` on `Sat, 22 Oct 2022 21:26:02 -0000`
...
## xacro (noetic) - 1.14.13-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Sat, 12 Feb 2022 14:07:08 -0000`
...
## xacro (melodic) - 1.13.17-1

The packages in the `xacro` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic xacro` on `Sat, 12 Feb 2022 13:42:39 -0000`
...
## xacro (noetic) - 1.14.12-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Sun, 30 Jan 2022 16:31:21 -0000`
...
## xacro (melodic) - 1.13.16-1

The packages in the `xacro` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic xacro` on `Sun, 30 Jan 2022 16:29:16 -0000`
...
## xacro (noetic) - 1.14.11-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Thu, 20 Jan 2022 09:13:38 -0000`
...
## xacro (melodic) - 1.13.15-1

The packages in the `xacro` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic xacro` on `Thu, 20 Jan 2022 09:11:04 -0000`
...
## xacro (noetic) - 1.14.10-1

The packages in the `xacro` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic xacro` on `Mon, 04 Oct 2021 22:52:03 -0000`
